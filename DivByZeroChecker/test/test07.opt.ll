...
entry:
  ...
  %cmp = icmp sgt i32 %call, 10, !dbg !16
...
if.end:                                           ; preds = %if.else, %if.then
  %y.0 = phi i32 [ 1, %if.then ], [ 2, %if.else ], !dbg !21
  call void @llvm.dbg.value(metadata i32 %y.0, metadata !14, metadata !DIExpression()), !dbg !15
  %div = sdiv i32 %call, %y.0, !dbg !22
  call void @llvm.dbg.value(metadata i32 %div, metadata !23, metadata !DIExpression()), !dbg !24
  ret void, !dbg !25
}
...
!1 = !DIFile(filename: "test07.c", directory: "/DivByZeroChecker/test")
!2 = !{}
...
!16 = !DILocation(line: 6, column: 9, scope: !17)
!17 = distinct !DILexicalBlock(scope: !7, file: !1, line: 6, column: 7)
!18 = !DILocation(line: 6, column: 7, scope: !7)
!19 = !DILocation(line: 8, column: 3, scope: !20)
!20 = distinct !DILexicalBlock(scope: !17, file: !1, line: 6, column: 15)
!21 = !DILocation(line: 0, scope: !17)
!22 = !DILocation(line: 11, column: 13, scope: !7)
!23 = !DILocalVariable(name: "z", scope: !7, file: !1, line: 11, type: !12)
