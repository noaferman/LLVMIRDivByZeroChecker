...
entry:
  ...
  store i32 %add, i32* %c, align 4, !dbg !16
  ...
  store i32 %div, i32* %d, align 4, !dbg !20
  %3 = load i32, i32* %c, align 4, !dbg !24
  %tobool = icmp ne i32 %3, 0, !dbg !24
  br i1 %tobool, label %if.then, label %if.end, !dbg !26

if.then:                                          ; preds = %entry
  call void @llvm.dbg.declare(metadata i32* %a1, metadata !27, metadata !DIExpression()), !dbg !29
  store i32 1, i32* %a1, align 4, !dbg !29
...
!1 = !DIFile(filename: "test01.c", directory: "/DivByZeroChecker/test")
!2 = !{}
...
!18 = !DILocation(line: 4, column: 13, scope: !7)
...
!23 = !DILocation(line: 5, column: 13, scope: !7)
!24 = !DILocation(line: 6, column: 7, scope: !25)
!25 = distinct !DILexicalBlock(scope: !7, file: !1, line: 6, column: 7)
!26 = !DILocation(line: 6, column: 7, scope: !7)
!27 = !DILocalVariable(name: "a", scope: !28, file: !1, line: 7, type: !10)
!28 = distinct !DILexicalBlock(scope: !25, file: !1, line: 6, column: 10)
!29 = !DILocation(line: 7, column: 9, scope: !28)
!30 = !DILocation(line: 8, column: 3, scope: !28)
