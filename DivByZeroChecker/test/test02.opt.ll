...
entry:
  %call = call i32 @getchar(), !dbg !11
  call void @llvm.dbg.value(metadata i32 %call, metadata !12, metadata !DIExpression()), !dbg !13
  %div = sdiv i32 5, %call, !dbg !14
  call void @llvm.dbg.value(metadata i32 %div, metadata !15, metadata !DIExpression()), !dbg !16
  ret i32 0, !dbg !17
}
...
!1 = !DIFile(filename: "test02.c", directory: "/DivByZeroChecker/test")
!2 = !{}
...
!11 = !DILocation(line: 4, column: 11, scope: !7)
