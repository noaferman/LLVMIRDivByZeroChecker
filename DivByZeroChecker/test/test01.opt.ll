...
entry:
  ...
  %div = sdiv i32 1, 0, !dbg !18
  call void @llvm.dbg.value(metadata i32 %div, metadata !19, metadata !DIExpression()), !dbg !20
  %tobool = icmp ne i32 %add, 0, !dbg !21
  br i1 %tobool, label %if.then, label %if.end, !dbg !23

if.then:                                          ; preds = %entry
  call void @llvm.dbg.value(metadata i32 1, metadata !24, metadata !DIExpression()), !dbg !26
...
!21 = !DILocation(line: 6, column: 7, scope: !22)
!22 = distinct !DILexicalBlock(scope: !7, file: !1, line: 6, column: 7)
!23 = !DILocation(line: 6, column: 7, scope: !7)
!24 = !DILocalVariable(name: "a", scope: !25, file: !1, line: 7, type: !10)
!25 = distinct !DILexicalBlock(scope: !22, file: !1, line: 6, column: 10)
!26 = !DILocation(line: 7, column: 9, scope: !25)
