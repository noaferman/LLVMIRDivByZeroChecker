...
if.else3:                                         ; preds = %if.else
  %sub = sub i32 %call, 2, !dbg !30
  call void @llvm.dbg.value(metadata i32 %sub, metadata !17, metadata !DIExpression()), !dbg !18
  br label %if.end

if.end:                                           ; preds = %if.else3, %if.then2
  %b.0 = phi i32 [ 0, %if.then2 ], [ %sub, %if.else3 ], !dbg !32
  call void @llvm.dbg.value(metadata i32 %b.0, metadata !17, metadata !DIExpression()), !dbg !18
  br label %if.end4

if.end4:                                          ; preds = %if.end, %if.then
  %b.1 = phi i32 [ %add, %if.then ], [ %b.0, %if.end ], !dbg !33
  call void @llvm.dbg.value(metadata i32 %b.1, metadata !17, metadata !DIExpression()), !dbg !18
  %div = udiv i32 10, %b.1, !dbg !34
  call void @llvm.dbg.value(metadata i32 %div, metadata !35, metadata !DIExpression()), !dbg !36
  ret void, !dbg !37
}
...
!25 = !DILocation(line: 10, column: 17, scope: !26)
!26 = distinct !DILexicalBlock(scope: !20, file: !1, line: 10, column: 14)
!27 = !DILocation(line: 10, column: 14, scope: !20)
!28 = !DILocation(line: 12, column: 3, scope: !29)
!29 = distinct !DILexicalBlock(scope: !26, file: !1, line: 10, column: 23)
!30 = !DILocation(line: 13, column: 12, scope: !31)
!31 = distinct !DILexicalBlock(scope: !26, file: !1, line: 12, column: 10)
!32 = !DILocation(line: 0, scope: !26)
!33 = !DILocation(line: 0, scope: !20)
!34 = !DILocation(line: 16, column: 15, scope: !7)
!35 = !DILocalVariable(name: "out", scope: !7, file: !1, line: 16, type: !12)
!36 = !DILocation(line: 16, column: 7, scope: !7)
